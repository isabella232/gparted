...
// Google Test 1.8.1 (and earlier) don't implement run-time test skipping so implement
// our own for GParted run-time detected unsupported file system features.
// Ref:
